...
if(isset($_POST['facility'])){
	...
	$sql = "SELECT * FROM task_reports tsk join facilities fac on tsk.facility_Id=fac.facility_Id join facilities fc on tsk.component_Id=fc.facility_id join sections sec on fac.section_id=sec.section_id join staff stf on tsk.user_Id=stf.staff_id order by task_Id;";
